...
namespace MultipleThreadedApplication
{
    ...
    public class NumbersCountUp
    {
        ...
        public void CountUp(Action<long> callbackFunction) //pass the callback function from the invoker thread as argument of the method in the thread
        {
            long sumOfNumbers = 0;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Create the callback function in the invoker thread
            Action<long> callbackFunction = (long value) =>
            {
                Console.WriteLine($"The value calculated from the thread is {value}");
            };
            ...
            {
            counter.CountUp(callbackFunction);
            });
