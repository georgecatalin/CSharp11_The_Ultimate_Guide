...
namespace CustomCollection_IList_T
{
    internal class Program
    {
        static void Main()
        {
            ...
            //Add another customer object with the same details
            Customer newCustomer1Copy = new Customer() { CustomerName = "ASorin", CustomerID = 200, CustomerType = TypeOfCustomer.VIPCustomer };
            ...
            bool isCustomerCopyIn = customers.Contains(newCustomer1Copy);
            Console.WriteLine("\n\nIs the customer in the collection  => " + isCustomerIn);
            Console.WriteLine("\nIs the customer copy  in the collection  => " + isCustomerCopyIn);
