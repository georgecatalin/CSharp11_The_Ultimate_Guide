...
namespace NeedOfImmutability
{
    public readonly struct BankAccount
    {
        ...
        /// <summary>
        /// starting from C#10 parameterless constructors can also be created.There is a condition though, to initialize all the fields in the parameterless constructors
        /// </summary>
        public BankAccount()
        {
            _accountNumber = 0;
    ...
    public class DataStorage
    {
        public static List<BankAccount> GetBankAccounts()
        {
            ...
            {
                new BankAccount(){AccountNumber = 100, CurrentBalance=123.5 }, //firstly run the constructor of the struct and at this stage initialize each field to 0, then reassign values in the object initializer
