...
namespace PatternMatching
{
    ...
    public class Description
    {
        ...
        {
            if (person is Employee employee) // verify if the variable person has the data type 'Employee' and then typecast it to Employee in the new variable 'employee' (second variable)
            {
                return $"{person.Name} {person.Age} {person.Gender} {employee.Salary}";
            }
            else if (person is Supplier supplier)
            {
