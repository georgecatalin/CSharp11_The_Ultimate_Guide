...
namespace PatternMatching
{
    ...
    public class Description
    {
        ...
        public static string GetDescription2(Person person)
        {
            ...
            {
                Person p when p.Age is < 13 => $"{p.Name} is nothing , but a child", // p.Age < 13
                Person p when p.Age is  >= 13 and  < 20 => $"{p.Name} is a teenager", // p.Age >= 13 && p.Age < 20
                Person p when p.Age is  >= 20 and < 60 => $"{p.Name} is an adult", // p.Age >= 20 && p.Age < 60
                Person p when p.Age is  > 60 and (not(100 or 200)) => $"{p.Name} is a senior.", // p.Age >60 && (p.Age != 100 && p.Age != 200)
                Person p when p.Age is 100 or 200 => $"{p.Name} is a centenarian", //
